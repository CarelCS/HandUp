...
namespace HandUpGUI.localhost {
    ...
    public partial class HandUpService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void AddTableAsync(int FKiEmployeeID, bool FKiEmployeeIDSpecified, int FKiProviderID, bool FKiProviderIDSpecified, int iGuestNumber, bool iGuestNumberSpecified, string sTableName, string sDescription) {
            this.AddTableAsync(FKiEmployeeID, FKiEmployeeIDSpecified, FKiProviderID, FKiProviderIDSpecified, iGuestNumber, iGuestNumberSpecified, sTableName, sDescription, null);
        }
        
        /// <remarks/>
        public void AddTableAsync(int FKiEmployeeID, bool FKiEmployeeIDSpecified, int FKiProviderID, bool FKiProviderIDSpecified, int iGuestNumber, bool iGuestNumberSpecified, string sTableName, string sDescription, object userState) {
            ...
            this.InvokeAsync("AddTable", new object[] {
                        ...
                        iGuestNumberSpecified,
                        sTableName,
                        sDescription}, this.AddTableOperationCompleted, userState);
        }
