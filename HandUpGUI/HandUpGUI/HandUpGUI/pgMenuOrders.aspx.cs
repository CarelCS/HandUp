    ...
    public partial class pgMenuOrders : System.Web.UI.Page {
                ...
                if (dsE.Tables[0].Rows[0]["FKiEmployeeType"].ToString() == "2") {
                    ...
                    if (dsTables.Tables.Count > 0) {
                        ...
                        foreach (DataRow dr in dsTables.Tables[0].Rows) {
                            ...
                            sTablesDisplay += "<td><table cellpadding=\"0\" cellspacing=\"0\"><tr><td><img id=\"Image1\" src=\"images/Icons/TopLeft.png\"  width='" + IconWidth / 2 + "'/></td><td valign=\"top\"><img id=\"Image1\" src=\"images/Icons/BorderBlockTopBottom.png\"  width='" + IconWidth * 7 + "'/></td><td><img id=\"Image1\" src=\"images/Icons/TopRight.png\"  width='" + IconWidth / 2 + "'/></td></tr><tr><td align=\"left\"><img id=\"Image1\" src=\"images/Icons/BorderBlockSides.png\"  width='" + IconWidth / 7 + "'/></td><td align=\"center\"><div style='cursor:pointer; color:White; font-weight:bolder; font-family:Arial' id=\"Table" + dr["PKiTableID"].ToString() + "\" onclick=\"OpenTable('" + dr["PKiTableID"].ToString() + "')\">" + dr["sTableName"].ToString() + "</div></td><td align=\"right\"><img id=\"Image1\" src=\"images/Icons/BorderBlockSides.png\"  width='" + IconWidth / 7 + "'/></td></tr><tr><td><img id=\"Image1\" src=\"images/Icons/BottomLeft.png\"  width='" + IconWidth / 2 + "'/></td><td valign=\"bottom\"><img id=\"Image1\" src=\"images/Icons/BorderBlockTopBottom.png\"  width='" + IconWidth * 7 + "'/></td><td><img id=\"Image1\" src=\"images/Icons/BottomRight.png\"  width='" + IconWidth / 2 + "'/></td></tr></table></td>";
                        }
        ...
        protected void PopulateMenu() {
            ...
            foreach (DataRow drGroups in ds.Tables["MenuGroup"].Rows) {
                ...
                MenuHeaders += "<td><table cellpadding=\"0\" cellspacing=\"0\"><tr><td><img id=\"Image1\" src=\"images/Icons/TopLeft.png\"  width='" + IconWidth / 2 + "'/></td><td valign=\"top\"><img id=\"Image1\" src=\"images/Icons/BorderBlockTopBottom.png\"  width='" + IconWidth * 7 + "'/></td><td><img id=\"Image1\" src=\"images/Icons/TopRight.png\"  width='" + IconWidth / 2 + "'/></td></tr><tr><td align=\"left\"><img id=\"Image1\" src=\"images/Icons/BorderBlockSides.png\"  width='" + IconWidth / 7 + "'/></td><td align=\"center\"><div style='cursor:pointer; color:White; font-weight:bolder; font-family:Arial' id=" + drGroups["PKiMenuGroupID"].ToString() + "Click onclick=ChangemenuArea(\"dvGroup" + drGroups["PKiMenuGroupID"].ToString() + "\")>" + drGroups["sMenuGroupName"].ToString() + "</div></td><td align=\"right\"><img id=\"Image1\" src=\"images/Icons/BorderBlockSides.png\"  width='" + IconWidth / 7 + "'/></td></tr><tr><td><img id=\"Image1\" src=\"images/Icons/BottomLeft.png\"  width='" + IconWidth / 2 + "'/></td><td valign=\"bottom\"><img id=\"Image1\" src=\"images/Icons/BorderBlockTopBottom.png\"  width='" + IconWidth * 7 + "'/></td><td><img id=\"Image1\" src=\"images/Icons/BottomRight.png\"  width='" + IconWidth / 2 + "'/></td></tr></table></td>";
